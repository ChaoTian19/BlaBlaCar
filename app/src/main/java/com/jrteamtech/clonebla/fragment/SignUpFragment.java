...
public class SignUpFragment extends Fragment implements View.OnClickListener {
    ...
    //    this.yearofbirth = (EditText) view.findViewById(R.id.spinner_year);
        ...
        this.adapter = new ArrayAdapter<>(getContext(), 17367048, this.genderItem);
        ...
        this.yearadapter = new ArrayAdapter<>(getContext(), 17367048, this.yearItem);
        this.adapter.setDropDownViewResource(17367049);
...
//        this.firstname.setOnKeyListener(new View.OnKeyListener() {
//            @Override
...
//        });
        ...
        if(this.genderItem.equals("") == true || this.firstname.getText().toString().equals("") == true ||
           this.lastname.getText().toString().equals("") == true  || this.yearItem.equals("") == true ||
           this.email.getText().toString().equals("") == true || this.password.getText().toString().equals("") ==true ||
           this.passwordconfirm.getText().toString().equals("") ==  true ) {
